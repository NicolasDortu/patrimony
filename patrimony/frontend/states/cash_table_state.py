...
from ...backend.api.cash_api import (
    add_cash,
    update_cash,
    delete_cash,
    get_all_cash,
)
from ...shared.models.assets import Cash, Currency
...
class CashTableState(rx.State):
    ...
    def update_cash_entry(self, form_data: dict) -> None:
        ...
        result = update_cash(id=self.edit_id, cash=cash)
